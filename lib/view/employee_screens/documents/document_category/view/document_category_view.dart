...
import 'package:yes_hrm/view/employee_screens/documents/document_category/view/widgets/document_loading_screen.dart';

import '../controller/controller.dart';
import 'widgets/document_category_card.dart';

class DocumentCategoryView extends GetView<DocumentCategoryController> {
  const DocumentCategoryView({super.key});
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text('Document Category', style: fontStyles.font20Black700Fixed),
              ],
            ),
          ),
          Padding(
