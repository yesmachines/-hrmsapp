...
import 'widgets/education_experience_row.dart';

class EducationExperienceView extends GetView<EducationExperienceController> {
  const EducationExperienceView({super.key});
...
class _EducationExperienceAppBar
    extends GetView<EducationExperienceController> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
...
class _InfoCard extends GetView<EducationExperienceController> {
  @override
  Widget build(BuildContext context) {
    return Container(
