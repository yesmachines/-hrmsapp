...
import 'package:yes_hrm/view/employee_screens/employee_details_screen/controller/controller.dart';
      ...
      body: SafeArea(
        child: Obx(() {
          return FutureBuilder(
            future: controller.employee.value == null
                ? controller.getEmployee()
                : null,
            builder: (context, snapshot) {
              final employee = controller.employee.value;
              if (employee == null && !controller.hasError.value) {
                return const Center(child: LoadingScreen());
              } else if (employee != null) {
                return _EmployeeDetailsBody(employee: employee);
              }
              return const NoDataPage(message: "Employee details not found");
            },
          );
        }),
      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: fontStyles.font14LightGrey400.copyWith(letterSpacing: 0),
          ),
            ...
            child: Column(
              children: [
                _DetailRow(
                  ...
                  label: 'Department',
                  value: Text(
                    employee.departmentShort.isEmpty
                        ? '-'
                ...
                _DetailRow(
                  ...
                  value: Text(
                    employee.officeLocation.isEmpty
                        ? '-'
                ...
                _DetailRow(
                  ...
                  label: 'Join Date',
                  value: Text(
                    employee.joinDate.isEmpty ? '-' : employee.joinDate,
                    style: fontStyles.font14Black600,
                    textAlign: TextAlign.right,
                  ),
                  showDivider: false,
...
class _StatusBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bg = isActive ? appColors.activeBadgeBg : appColors.rejectedBadgeBg;
    final text = isActive
