...
import 'widgets/employment_info_row.dart';

class EmploymentInformationView
    extends GetView<EmploymentInformationController> {
  const EmploymentInformationView({super.key});
...
class _InfoCard extends GetView<EmploymentInformationController> {
  @override
  Widget build(BuildContext context) {
    return Container(
